    ...
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto p-6">
        <Card className="mx-auto max-w-lg rounded-xl border border-slate-100 bg-white shadow-none">
          <CardHeader>
            <h2 className="text-base font-semibold text-slate-700">Create AI agent</h2>
            <p className="text-xs text-slate-500">Configure an agent to summarize deals, suggest follow-ups, or score leads.</p>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-xs">Agent name</Label>
              <Input id="name" placeholder="e.g. Deal summary agent" className="rounded-lg border-slate-200 text-sm" />
            </div>
